Check out these resources to deepen your knowledge on Splunk Observability.

## Courses
- [Splunk IM Fundamentals](https://education.splunk.com/instructor-led-training/splunk-infrastructure-monitoring-fundamentals)
- [Visualizing and Alerting in Splunk IM](https://education.splunk.com/instructor-led-training/visualizing-and-alerting-in-splunk-infrastructure-monitoring)
- [Ingesting App Metrics in Splunk IM](https://education.splunk.com/instructor-led-training/ingesting-application-metrics-in-splunk-im)
- [Automation Using the REST and SignalFlow APIs](https://education.splunk.com/instructor-led-training/automation-using-the-rest-and-signalflow-apis)
